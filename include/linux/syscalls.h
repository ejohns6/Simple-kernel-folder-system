...
asmlinkage long sys_create_mbox_421(unsigned long arg1, int enable_crypt);

asmlinkage long sys_mbox_421(unsigned long id);

asmlinkage long sys_count_mbox_421(void);

asmlinkage long list_mbox_421(unsigned __user *mbxes, long k);
